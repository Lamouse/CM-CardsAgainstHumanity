...
public class RoomPeersFragment extends ListFragment
{
    ...
    public static RoomPeersFragment newInstance(String param1, String param2)
    {
        RoomPeersFragment fragment = new RoomPeersFragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public RoomPeersFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_room_peers, container, false);
    }
